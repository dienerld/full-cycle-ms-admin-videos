...
describe('[Unit] Category Validator', () => {
  describe('create command', () => {
    test('should an invalid category with name property', () => {
      ...
      expect(() =>
        Category.create({ name: 5 as unknown as string }),
      ).containsErrorMessages({
        name: [
          'name must be a string',
          'name must be shorter than or equal to 255 characters',
    ...
    it('should a invalid category using is_active property', () => {
      expect(() =>
        Category.create({ is_active: 5 } as unknown as Category),
      ).containsErrorMessages({
  ...
  describe('changeName method', () => {
    it('should a invalid category using name property', () => {
      ...
      expect(() =>
        category.changeName(null as unknown as string),
      ).containsErrorMessages({
        name: [
          'name should not be empty',
          'name must be a string',
      ...
      expect(() =>
        category.changeName(5 as unknown as string),
      ).containsErrorMessages({
        name: [
          'name must be a string',
          'name must be shorter than or equal to 255 characters',
  ...
  describe('changeDescription method', () => {
    it('should a invalid category using description property', () => {
      const category = Category.create({ name: 'Movie' });
      expect(() =>
        category.changeDescription(5 as unknown as string),
      ).containsErrorMessages({
        description: ['description must be a string'],
      });
    });
