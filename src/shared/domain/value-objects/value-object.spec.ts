...
describe('ValueObject Unit Tests', () => {
  ...
  test('should not be equals', () => {
    ...
    expect(valueObject1.equals(null as never)).toBe(false)
    expect(valueObject1.equals(undefined as never)).toBe(false)

    const complexValueObject1 = new ComplexValueObject('test', 1)
    const complexValueObject2 = new ComplexValueObject('test', 2)
    expect(complexValueObject1.equals(complexValueObject2)).toBe(false)
    expect(complexValueObject1.equals(null as never)).toBe(false)
    expect(complexValueObject2.equals(undefined as never)).toBe(false)
  })
})
